...
";
  ...
  <div class=\"second-sidebar\">";
    ...
    <a class=\"social-share action-button\" href=\"mailto:?subject=";
        // line 145
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "title", [], "any", false, false, true, 145), "value", [], "any", false, false, true, 145), 145, $this->source), "html", null, true);
        echo "&body=";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["current_url"] ?? null), 145, $this->source), "html", null, true);
...
goUP.addEventListener('click', goUp)
    ...
    <script nonce=\"";
        // line 226
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "csp_nonce", [], "any", false, false, true, 226), 226, $this->source), "html", null, true);
        echo "\">
...
<script>
   // open websocket connection
        ...
        chatMessageInput.addEventListener('keyup', (event) => {
            if (event.keyCode === 13) {
                ...
                chatSocket.send(JSON.stringify({
                    ...
                    'participant': '";
        // line 350
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["logged_in"] ?? null), 350, $this->source), "html", null, true);
        echo "' ? 'Admin' : 'Me',
                }));
            }
        });
        ...
        chatMessageSubmit.addEventListener('click', () => {
            ...
            const participant = '";
        // line 358
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["logged_in"] ?? null), 358, $this->source), "html", null, true);
        echo "' ? 'Admin' : 'Me';
...
";
    ...
    {
        return array (  457 => 358,  446 => 350,  405 => 311,  323 => 226,  282 => 192,  262 => 174,  229 => 145,  219 => 138,  216 => 137,  206 => 133,  202 => 132,  199 => 131,  195 => 130,  171 => 109,  166 => 107,  158 => 101,  150 => 96,  141 => 89,  139 => 88,  91 => 43,  87 => 41,  79 => 35,  73 => 31,  71 => 30,  54 => 16,  47 => 11,  45 => 7,  44 => 4,  41 => 2,  39 => 1,);
    }
