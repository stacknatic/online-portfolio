...
<div class=\"social-share-container\">
    <div id=\"sharebTn\"><button id=\"share-button\" title=\"share\">Share</button></div>
    ...
    <a href=\"whatsapp://send?text=";
        ...
        echo "\" target=\"_blank\"><i class=\"fa-brands fa-whatsapp\"></i></a>
...
goUP.addEventListener('click', goUp)
    ...
    <script nonce=\"";
        // line 240
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "csp_nonce", [], "any", false, false, true, 240), 240, $this->source), "html", null, true);
        echo "\">
...
<script>
   // open websocket connection
        ...
        chatMessageInput.addEventListener('keyup', (event) => {
            if (event.keyCode === 13) {
                ...
                chatSocket.send(JSON.stringify({
                    ...
                    'participant': '";
        // line 364
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["logged_in"] ?? null), 364, $this->source), "html", null, true);
        echo "' ? 'Admin' : 'Me',
                }));
            }
        });
        ...
        chatMessageSubmit.addEventListener('click', () => {
            ...
            const participant = '";
        // line 372
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["logged_in"] ?? null), 372, $this->source), "html", null, true);
        echo "' ? 'Admin' : 'Me';
...
";
    ...
    {
        return array (  479 => 372,  468 => 364,  427 => 325,  345 => 240,  300 => 202,  280 => 184,  244 => 152,  239 => 150,  232 => 148,  219 => 138,  216 => 137,  206 => 133,  202 => 132,  199 => 131,  195 => 130,  171 => 109,  166 => 107,  158 => 101,  150 => 96,  141 => 89,  139 => 88,  91 => 43,  87 => 41,  79 => 35,  73 => 31,  71 => 30,  54 => 16,  47 => 11,  45 => 7,  44 => 4,  41 => 2,  39 => 1,);
    }
